...
RopeArrowWorld:
    ...
    events:
        on player shoots bow:
            ...
            - if <context.bow.script.name> == GrappleArrowBow:
        ...
        on player clicks block:
            - if <player.is_sneaking> && <player.has_flag[ropearrow]>:
                - if <context.location.block.material.name> == IRON_BARS:
                    - if <player.location.cuboids.contains_text[<player.flag[ropearrow]>]>:
                        - define theCuboid:cu@<player.flag[ropearrow]>
                        # - narrate "<[theCuboid]>"
                        #- narrate "<[theCuboid].outline>"
