...
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [i@ActiveQuests] [i@CompletedQuests1MenuItem]"
...
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [i@QuestJournal2MenuItem] [i@CompletedQuests1MenuItem]"
# QuestJournal1MenuItem:
#   type: item
#   material: book
#   display name: Active Quests - Page 2
#   lore:
#   - "Click here to view your active quests."
...
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [] []"
#   - "[] [] [] [] [] [] [] [i@QuestJournal1MenuItem] [i@CompletedQuests1MenuItem]"
# QuestJournal1MenuItem:
#   type: item
#   material: book
#   display name: Active Quests - Page 1
#   lore:
#   - "Click here to view your active quests."

# # Preview Item for Completed Quests 1
# CompletedQuests1MenuItem:
#   type: item
#   material: book
