...
CoalRunning3Assignment:
    ...
    actions:
        ...
        on enter proximity:
            - inject LoadNPCStep
    interact scripts:
    - 1 CoalRunning3Interact

CoalRunning3Interact:
    type: interact
    steps:
        1:
            chat trigger:
            ...
            chat trigger:
                ...
                2:
                    ...
                    script:
                        ...
                        - run AddActiveQuest def:<player>|CoalRunning3ActiveItem
                        - zap 3
                3:
                ...
                2:
                    ...
                    script:
                        - if <player.inventory.contains[coal].quantity[64]>:
                            ...
                            - run RemoveActiveQuest def:<player>|CoalRunning3ActiveItem
                            - if !<player.flag[CompletedQuestItems].contains[CoalRunning3CompletedItem]>:
                                - run AddCompletedQuest def:<player>|CoalRunning3CompletedItem
                            - zap 1
                        - else:
...
#======================QuestItems====================#
#====================================================#
CoalRunning3GuideBook:
    type: book
    author: Active Quest
    title: Coal Running
    signed: yes
    text:
        - "After arriving at Waystation 3, I met a man who asked me to deliver him a stack of coal."
        - "He said I could bring it to him at -3774, -862. He'd pay me more than the typical sell price."
CoalRunning3QuestCompleted:
    type: book
    author: Completed Quest
    title: Coal Running
    signed: yes
    text:
        - "I delivered a decent coal shipment to Waystation 3."
CoalRunning3ActiveItem:
    type: item
    material: written_book
    book: CoalRunning3GuideBook
CoalRunning3CompletedItem:
    type: item
    material: written_book
    book: CoalRunning3QuestCompleted